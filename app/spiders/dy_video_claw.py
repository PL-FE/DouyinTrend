...
class DouyinVideo():
    ...
    def inits(self, choose, cookie_str):
        ...
        for url in choose:
            ...
            return self.parse(sec_user_id, cookies)

    def parse(self, sec_user_id, cookies):
        reuslut = {}
        data = []
        reuslut['has_more'] = 1
